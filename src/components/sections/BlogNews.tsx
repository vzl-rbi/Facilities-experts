      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 flex flex-col items-start gap-y-6 sm:flex-row sm:items-center sm:justify-between mb-12 lg:mb-16">
          ...
          <div className="flex items-center gap-3">
            <a
              href="/blog"
              className="inline-flex items-center justify-center px-5 py-2.5 text-sm font-medium text-gray-800 bg-amber-600 border border-transparent rounded-md shadow-sm hover:bg-amber-600 focus:outline-none focus:ring-2 focus:ring-amber-600 focus:ring-offset-2 transition-colors whitespace-nowrap"
          ...
          {blogPosts.map((post) => (
            ...
            >
              ...
              <div className="p-5 flex flex-col flex-grow">
                {/* Category badge */}
                <div className="mb-3">
                  <span className="inline-flex items-center px-3 py-1 text-xs font-semibold text-gray-800 bg-amber-600 rounded-full">
                    {post.category}
                  </span>
                </div>
                ...
                <div className="flex items-center gap-3 mt-auto">
                  <a
                    href={post.slug}
                    className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-gray-800 bg-amber-600 rounded-md shadow-sm hover:bg-amber-600 focus:outline-none focus:ring-2 focus:ring-amber-600 focus:ring-offset-2 transition-colors"
                  >
                    Read More
                  </a>
                  <a
                    href={post.slug}
                    className="inline-flex items-center justify-center w-8 h-8 bg-amber-600 hover:bg-slate-700 transition-colors"
